          ...
          <div className="sobre-mi-container">
            ...
            <div className="sobre-mi-info">
              <p>
                <FormattedMessage
                  id='about-info-1'
                  defaultMessage="Hi, I'm Saru CM, an engineering graduate in Electronics and Communication from Anna University. Currently, I'm interning at Stack Mode, where I've been involved in several projects using React for frontend development and Node.js for backend solutions. I'm passionate about leveraging these technologies to create innovative and effective web applications."
                />
              </p>
              ...
              <div className="hide parrafo-active">
                ...
                <p>
                  {/* <FormattedMessage
                    id='about-info-3'
                    defaultMessage="I completed lot of projects"
                  /> */}
                </p>
              </div>
