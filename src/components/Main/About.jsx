        ...
        <div className="row container">
            <div className="columns" data-aos="fade-right" data-aos-delay="300">
                ...
                <h4>
                    <FormattedMessage
                        id='description'
                        defaultMessage='My name is Saru CM and I am a full stack developer.'
                    />
                </h4>
                <p>
                    <FormattedMessage
                        id='my-description'
                        defaultMessage=' looking to learn new technologies to enrich my skills and improve my good practices as a developer.'
                    />
                </p>
                <ul>
                    <li>
                    ...
                    <li>
                        <p>
                            <span>
                                ...
                                Reading Books, listening music and Programming
                        </p>
                    </li>
                    <li>
                        <p><span>Email:</span> 98sarucm@gmail.com</p>
                    </li>
                    <li>
                        <p>
                            <span>
