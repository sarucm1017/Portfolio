        ...
        <section className="inicio" id="inicio">
            ...
            <div className="titulo">
                ...
                <div className="redes-sociales">
                    <a href="https://www.linkedin.com/in/saru-c-m-819046310/" target="_blank" rel="noopener noreferrer" data-aos="fade-up" data-aos-delay="1200"><i className="fab fa-linkedin"></i></a>
                ...
                <div className="wrapper">
                    <a className="button" href="https://www.linkedin.com/in/saru-c-m-819046310/" target="_blank" rel="noopener noreferrer" data-aos="fade-up" data-aos-delay="1200">
                        <div className="icon">
